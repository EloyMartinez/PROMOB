...
public class QuizzMainActivity extends AppCompatActivity {
    ...
    private final String[] dogAR = {"D", "O", "O", "L", "F", "F", "I", "G", "M", "B"};
    private final String dog = "DOG";
    private final String[] horseAR = {"H", "O", "R", "S", "E", "F", "I", "G", "M", "O"};
    private final String horse = "HORSE";
    private final String[] fishAR = {"F", "I", "S", "H", "E", "F", "I", "G", "M", "O"};
    private final String fish = "FISH";
    private final String[] birdAR = {"H", "O", "R", "S", "E", "B", "I", "R", "D", "O"};
    private final String bird = "BIRD";
    private final String[] pigAR = {"H", "O", "I", "P", "E", "B", "I", "G", "D", "O"};
